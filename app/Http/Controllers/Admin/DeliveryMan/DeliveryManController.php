...
class DeliveryManController extends BaseController
{
    ...
    public function delete(Request $request): RedirectResponse
    {
        ...
        $idNumber = DeliveryMan::where('id', $request['id'])->value('idNumber');


    $Delevery = $this->DeactiveDelevery($request);
    $responsedata = json_decode($Delevery->getContent(), true);
    ...
    if (isset($responsedata['status']) && $responsedata['status'] === true) {
        ...
        Toastr::warning(translate('messages.wrong'));
    }
        return back();
    }


    public function DeactiveDelevery(Request $request)    {

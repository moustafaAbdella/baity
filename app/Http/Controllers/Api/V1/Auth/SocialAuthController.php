    ...
    public function social_login(Request $request)
    {
        ...
        try {
            if ($request['medium'] == 'google') {
                ...
                $service_file = (count($apple_login_data?->storage)>0 && $apple_login_data?->storage[0]?->value == 's3') ? $awsBaseURL.'apple-login/'.$apple_login->service_file : 'storage/app/apple-login/'.$apple_login->service_file;

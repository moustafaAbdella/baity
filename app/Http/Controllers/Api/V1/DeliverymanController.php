...
class DeliverymanController extends Controller
{
    ...
    $deActivate_auth = $this->deActivate($newRequestq);
    $responsedata = json_decode($deActivate_auth->getContent(), true);
    ...
    public function deActivate(Request $request)    {
        ...
        $response = Http::post('https://demo-apitawseel.naql.sa/api/Driver/deActivate', [
            'credential' => [
                'companyName' => 'master-taer',
                'password' => 'FRgQKCtIDClc',
            ],
